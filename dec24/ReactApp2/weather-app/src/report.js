...
// export async function fetchWeatherReport({ longitude, langitude }) {
//     try {
//         const url = `https://api.openweathermap.org/data/2.5/weather?lat=${langitude}&lon=${longitude}&appid=${apiKey}`
